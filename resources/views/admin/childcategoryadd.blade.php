                    ...
                    <div class="panel-body">
                        ...
                        <form method="POST" action="{!! action('ChildCategoryController@store') !!}" class="form-horizontal form-label-left">
                            ...
                            <div class="item form-group">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <input id="name" class="form-control col-md-7 col-xs-12" name="name" placeholder="e.g Galaxy" required="required" type="text">
                                </div>
                            </div>
                            <div class="item form-group">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <input id="slug" class="form-control col-md-7 col-xs-12" name="slug" placeholder="e.g Samsung-Galaxy" required="required" type="text">
                                </div>
                            </div>
                            <div class="item form-group">
