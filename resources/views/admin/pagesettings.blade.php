                    ...
                    <div class="panel-body">
                        ...
                        <div class="col-md-12">
                            <ul class="nav nav-tabs tabs-left">
                                ...
                                <li><a href="#banner" data-toggle="tab" aria-expanded="false">Banners</a></li>
                            ...
                            <div class="tab-content">
                              ...
                              <textarea rows="10" class="form-control" name="about" id="content1" placeholder="About Page Contents" required="required">{{$pagedata->about}}</textarea>
                                ...
                                <div class="tab-pane" id="banner">
                                    <div class="pull-right">
                                        <a href="{!! url('admin/banners/add') !!}" class="btn btn-primary btn-add"><i class="fa fa-plus"></i> Add New Banner</a>
                                    </div>
                                    <p class="lead">Home Banners</p>
                                    <table class="table" id="example">
                                        <thead>
                                            <tr>
                                                <th width="35%">Banners</th>
                                                <th width="45%">HyperLink</th>
                                                <th width="20%">Action</th>
                                            </tr>
                                        </thead>
                                        ...
                                        @foreach($bann as $banner)
                                            <tr>
                                                ...
                                                <td>{{$banner->link}}</td>
                                                <td>
                                                    <a href="banners/{{$banner->id}}/edit" class="btn btn-primary btn-xs"><i class="fa fa-edit"></i> Edit </a>
                                                    <a href="banners/{{$banner->id}}/delete" class="btn btn-danger btn-xs"><i class="fa fa-trash"></i> Remove </a>
                                                </td>
                                            </tr>
                                        @endforeach
                                        </tbody>
