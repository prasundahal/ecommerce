...
Route::get('/old', function () {
    return view('includes.oldnewmaster');
});
...
Route::get('admin/banners/add', 'PageSettingsController@addbanners');
Route::post('admin/banners/save', 'PageSettingsController@bannerssave');
Route::get('admin/banners/{id}/delete', 'PageSettingsController@bannersdelete');
Route::get('admin/banners/{id}/edit', 'PageSettingsController@bannersedit');
Route::post('admin/banners/{id}/update', 'PageSettingsController@bannersupdate');
