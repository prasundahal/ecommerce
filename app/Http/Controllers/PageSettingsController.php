...
class PageSettingsController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('admin.pagesettings',compact('pagedata','faqs','brands','banners','bann'));
    }
...

{
    ...
    return view('admin.newbanneradd');
}

public function bannersdelete($id)
{
    Bran::findOrFail($id)->delete();
    return redirect('admin/pagesettings')->with('message','Banner Deleted Successfully.');
}

public function bannersedit($id)
{
    $banner = Bran::findOrFail($id);
    
    return view('admin.newbanneredit',compact('banner'));
}
